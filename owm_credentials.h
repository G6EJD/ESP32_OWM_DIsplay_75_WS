...
String LAT              = "yourLAT";                       // Latitude of your location
String LON              = "yourLON";                       // Longitude of your location
...
const char* ntpServer   = "uk.pool.ntp.org";               // Or, choose a time server close to you, but in most cases it's best to use pool.ntp.org to find an NTP server
